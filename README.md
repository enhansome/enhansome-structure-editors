...
|                                                                      [Unison](https://unisonweb.org) |         💵 📖 👶 λ        | Code database projected to text-files edited in your text editor of choice. Originally centered around having a projectional editor, but pivoted to creating a cloud programming language first |   Haskell   |      [6206](https://github.com/unisonweb/unison) ⭐ 6,702 \| 🐛 1,271 \| 🌐 Haskell \| 📅 2026-08-12      |   2025  |
|                                                                       [Unit](https://unit.software/) |          ⤴️ 👶 🌐         | A general purpose visual programming system                                                                                                                                                     |  TypeScript |      [4379](https://github.com/samuelmtimbo/unit) ⭐ 4,918 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-17      |   2025  |
...
|                                                                [MPS](https://www.jetbrains.com/mps/) |        💵 ⌨️ 🧰 🔨        | Language workbench for projectional languages                                                                                                                                                   |     Java    |       [1615](https://github.com/JetBrains/MPS) ⭐ 1,654 \| 🐛 7 \| 🌐 JetBrains MPS \| 📅 2026-08-17      |   2025  |
...
|                                                                            [Hazel](http://hazel.org) |       🎓 ⌨️ 👶 λ 🌐       | Language with live programming and typed holes                                                                                                                                                  |    Reason   |        [1038](https://github.com/hazelgrove/hazel) ⭐ 1,127 \| 🐛 426 \| 🌐 Reason \| 📅 2026-08-18       |   2025  |
...
|                                                                               [Eyg](https://eyg.run) |          👶 λ 🌐          | Minimal language to enable exploration of alternative editing methods                                                                                                                           |    Gleam    |         [248](https://github.com/crowdhailer/eyg-lang) ⭐ 357 \| 🐛 0 \| 🌐 Gleam \| 📅 2026-08-17        |   2025  |
...
| [JSON Editor](https://github.com/json-editor/json-editor.git) ⭐ 4,904 \| 🐛 294 \| 🌐 JavaScript \| 📅 2026-07-03 |     🌐     | JSON schema-based editor | JavaScript   |
