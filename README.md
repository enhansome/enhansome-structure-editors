...
| ---------------------------------------------------------------------------------------------------: | :-----------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | :------------------------------------------------------------------------------------------------------: | :-----: |
|                                                                             [Enso](https://enso.org) |       💵 📖 ⤴️ 👶 λ       | Hybrid visual+textual programming language                                                                                                                                                      | Scala, Rust |          [7441](https://github.com/enso-org/enso) ⭐ 7,440 \| 🐛 325 \| 🌐 Java \| 📅 2026-08-10          |   2025  |
|                                                                      [Unison](https://unisonweb.org) |         💵 📖 👶 λ        | Code database projected to text-files edited in your text editor of choice. Originally centered around having a projectional editor, but pivoted to creating a cloud programming language first |   Haskell   |      [6206](https://github.com/unisonweb/unison) ⭐ 6,736 \| 🐛 1,272 \| 🌐 Haskell \| 📅 2026-08-19      |   2025  |
|                                                                       [Unit](https://unit.software/) |          ⤴️ 👶 🌐         | A general purpose visual programming system                                                                                                                                                     |  TypeScript |      [4379](https://github.com/samuelmtimbo/unit) ⭐ 4,916 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-09-21      |   2025  |
|                                                                        [Lamdu](http://www.lamdu.org) |        ♡ ⌨️ 👶 λ 文        | Language with live programming and novel UX for type errors                                                                                                                                     |   Haskell   |          [1873](https://github.com/lamdu/lamdu) ⭐ 1,899 \| 🐛 25 \| 🌐 Haskell \| 📅 2026-08-21          |   2025  |
|                                                                [MPS](https://www.jetbrains.com/mps/) |        💵 ⌨️ 🧰 🔨        | Language workbench for projectional languages                                                                                                                                                   |     Java    |       [1615](https://github.com/JetBrains/MPS) ⭐ 1,660 \| 🐛 7 \| 🌐 JetBrains MPS \| 📅 2026-09-21      |   2025  |
|                                                            [Cursorless](https://www.cursorless.org/) |          ♡ 📖 🔨          | Spoken language for structural code editing                                                                                                                                                     |  TypeScript | [1266](https://github.com/cursorless-dev/cursorless) ⭐ 1,334 \| 🐛 532 \| 🌐 TypeScript \| 📅 2026-09-21 |   2025  |
|                                                                            [Hazel](http://hazel.org) |       🎓 ⌨️ 👶 λ 🌐       | Language with live programming and typed holes                                                                                                                                                  |    Reason   |        [1038](https://github.com/hazelgrove/hazel) ⭐ 1,156 \| 🐛 457 \| 🌐 Reason \| 📅 2026-09-22       |   2025  |
...
|                                                                               [Eyg](https://eyg.run) |          👶 λ 🌐          | Minimal language to enable exploration of alternative editing methods                                                                                                                           |    Gleam    |         [248](https://github.com/crowdhailer/eyg-lang) ⭐ 369 \| 🐛 0 \| 🌐 Gleam \| 📅 2026-09-21        |   2025  |
...
| [Javardise](https://github.com/andre-santos-pt/javardise) ⭐ 7 \| 🐛 22 \| 🌐 Kotlin \| 📅 2026-09-21 |           🎓 📖           | Editor for a subset of Java                                                                                                                                                                     |    Kotlin   |                                                     6                                                    |   2025  |
...
| [JSON Editor](https://github.com/json-editor/json-editor.git) ⭐ 4,904 \| 🐛 294 \| 🌐 JavaScript \| 📅 2026-08-25 |     🌐     | JSON schema-based editor | JavaScript   |
